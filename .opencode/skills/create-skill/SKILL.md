...
- This skill is a template guiding the creation and upgrade of other skills.
- Start by reading this document and the references to structure SKILL.md correctly.
- Use this as a scaffold when creating new SKILL.md files, including frontmatter and references.
